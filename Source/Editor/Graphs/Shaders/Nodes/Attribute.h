...
inline void DrawInputIntAttribute( const char* name, float& value, bool connected, bool hasEditorValues, int id )
{
...
inline void DrawInput( const SSocketType::var_type& type, std::string_view name, std::array<float, 3>& value, bool isConnected, bool hasEditorValues, int id )
{
    switch ( type )
    {
        case SSocketType::var_type::none: break;
        case SSocketType::var_type::int_type: DrawInputIntAttribute( name.data(), value[ 0 ], isConnected, hasEditorValues, id ); break;
        case SSocketType::var_type::float_type: DrawInputFloatAttribute( name.data(), value[ 0 ], isConnected, hasEditorValues, id ); break;
        case SSocketType::var_type::color: DrawInputColorAttribute( name.data(), value, isConnected, hasEditorValues, id ); break;
        case SSocketType::var_type::vector2:
        case SSocketType::var_type::vector3:
        case SSocketType::var_type::vector4: DrawInputVectorAttribute( name.data(), value, isConnected, hasEditorValues, id ); break;
        case SSocketType::var_type::shader: DrawInputShaderAttribute( name.data(), id ); break;
    }
}
inline void DrawOutput( const SSocketType::var_type& type, std::string_view name, int id )
{
    ...
    {
        case SSocketType::var_type::none: break;
        case SSocketType::var_type::int_type:
        case SSocketType::var_type::float_type: DrawOutputFloatAttribute( name.data(), id ); break;
        case SSocketType::var_type::color: DrawOutputColorAttribute( name.data(), id ); break;
        case SSocketType::var_type::vector2:
        case SSocketType::var_type::vector3:
        case SSocketType::var_type::vector4: DrawOutputVectorAttribute( name.data(), id ); break;
        case SSocketType::var_type::shader: DrawOutputShaderAttribute( name.data(), id ); break;
    }
}
