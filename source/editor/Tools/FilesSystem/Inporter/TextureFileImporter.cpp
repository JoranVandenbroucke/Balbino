...
bool CTextureFileImporter::DrawImportSettings() noexcept
{
    if (Gui::StartPopup("Import Texture", true, {500, -1}))
    {
        ...
        const std::vector<std::string> textureTypes{
            ToString(FawnVision::image_view_type::view_1d),         ToString(FawnVision::image_view_type::view_1d_array), ToString(FawnVision::image_view_type::view_2d),
        ...
        const std::vector<std::string> wrapModes{ToString(FawnVision::sampler_address_mode::repeat), ToString(FawnVision::sampler_address_mode::mirrored_repeat),
                                                 ToString(FawnVision::sampler_address_mode::clamp_to_edge), ToString(FawnVision::sampler_address_mode::clamp_to_border),
                                                 ToString(FawnVision::sampler_address_mode::mirror_clamp_to_edge)};
        const std::vector<std::string> sampleModes{ToString(FawnVision::image_filter::nearest), ToString(FawnVision::image_filter::linear)};
        const std::vector<std::string> sampleLevels{ToString(sample_level::one),        ToString(sample_level::two),       ToString(sample_level::four),
                                                    ToString(sample_level::eight),      ToString(sample_level::sixteen),   ToString(sample_level::thirty_two),
                                                    ToString(sample_level::sixty_four), ToString(sample_level::auto_level)};
        const std::vector<std::string> componentMapping{ToString(FawnVision::component_swizzle::swizzle_identity), ToString(FawnVision::component_swizzle::swizzle_zero),
                                                        ToString(FawnVision::component_swizzle::swizzle_one),      ToString(FawnVision::component_swizzle::swizzle_r),
                                                        ToString(FawnVision::component_swizzle::swizzle_g),        ToString(FawnVision::component_swizzle::swizzle_b),
                                                        ToString(FawnVision::component_swizzle::swizzle_a)};
        const std::vector<std::string> borderColors{ToString(FawnVision::border_color::float_transparent_black), ToString(FawnVision::border_color::int_transparent_black),
                                                    ToString(FawnVision::border_color::float_opaque_black),      ToString(FawnVision::border_color::int_opaque_black),
                                                    ToString(FawnVision::border_color::float_opaque_white),      ToString(FawnVision::border_color::int_opaque_white)};
...
bool CTextureFileImporter::LoadTextureWithSDL()
{
    ...
    m_createInfo.imageViewCreateInfo.componentMapping
        = ((uint32_t)m_componentMapping.r) | (((uint32_t)m_componentMapping.g) << 8) | (((uint32_t)m_componentMapping.b) << 16) | (((uint32_t)m_componentMapping.a) << 24);
