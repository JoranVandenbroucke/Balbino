...
std::unordered_map<FawnForge::CShaderEditor::ui_node_type, const char*> FawnForge::CShaderEditor::m_nodeNameMap{
    {ui_node_type::vertex_output, "Shaders/Vertex Shader"},
...
bool FawnForge::CShaderEditor::DrawBinding(SShaderBinding& binding) noexcept
{
    ...
    {
        bool isInOut{binding.layoutType == SShaderBinding::layout::input || binding.layoutType == SShaderBinding::layout::output
                     || binding.layoutType == SShaderBinding::layout::subpass_input || binding.layoutType == SShaderBinding::layout::subpass_output};
        if (isInOut)
        {
            Gui::Disable();
        }
...
void FawnForge::CShaderEditor::EnterFileName() noexcept
{
    ...
    if (Gui::StartPopup("Save Shader", true, {256, -1}))
    {
        ...
        {
            m_currentShaderFile.fileName = "";
            m_currentShaderFile.fileName.append(name,
