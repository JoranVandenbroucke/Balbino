...
{
    (void)pEntity;
    DrawComponent<CervidaeComponent::CTransformComponent>("Transform", pEntity,
                                                          [](auto component)
                                                          {
    ...
    DrawComponent<CervidaeComponent::CCameraComponent>("Camera", pEntity,
                                                       [](auto& component)
                                                       {
    ...
    DrawComponent<CervidaeComponent::CMeshRenderComponent>("Mesh Render Component", pEntity,
                                                           [&](auto& component)
                                                           {
    ...
    DrawComponent<CervidaeComponent::CLightComponent>("Light Component", pEntity,
                                                      [](auto& component)
                                                      {
