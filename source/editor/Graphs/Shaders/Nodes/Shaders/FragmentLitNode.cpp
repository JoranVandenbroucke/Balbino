...
CFragmentLitNode::CFragmentLitNode(int& id)
    : CShaderNode{id,
                  {SSocketType{.type = SSocketType::var_type::color, .name = "colour", .uiName = "Colour"},
                   SSocketType{.type = SSocketType::var_type::float_type, .name = "metallic", .uiName = "Metallic"},
                   SSocketType{.type = SSocketType::var_type::float_type, .name = "roughness", .uiName = "Roughness"},
                   SSocketType{.type = SSocketType::var_type::float_type, .name = "occlusion", .uiName = "Ambient Occlusion"},
...
void CFragmentLitNode::GetShaderInfo(SShaderInfo& shaderInfo) const
{
    ...
    binding.members.emplace_back(SShaderBinding::layout::max, SShaderBinding::value_type::struct_type, SShaderBinding::autoConfig, SShaderBinding::autoConfig, "LIGHT_COUNT",
                                 "lights", "Light");
