...
CMappingNode::CMappingNode(int& id)
    : CShaderNode{id,
                  {SSocketType{.hasEditorValues = false, .type = SSocketType::var_type::vector3, .name = "vector", .uiName = "Vector"},
                   SSocketType{.type = SSocketType::var_type::vector3, .name = "location", .uiName = "Location"},
                   SSocketType{.type = SSocketType::var_type::vector3, .name = "rotation", .uiName = "Rotation"},
                   SSocketType{.type = SSocketType::var_type::vector3, .name = "scale", .uiName = "Scale"}},
