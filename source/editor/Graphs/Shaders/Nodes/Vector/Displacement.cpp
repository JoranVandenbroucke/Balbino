...
CDisplacementNode::CDisplacementNode(int& id)
    : CShaderNode{id,
                  {SSocketType{.type = SSocketType::var_type::float_type, .name = "height", .uiName = "Height"},
                   SSocketType{.type = SSocketType::var_type::float_type, .name = "mid_level", .uiName = "Mid Level"},
                   SSocketType{.type = SSocketType::var_type::float_type, .name = "strength", .uiName = "Strength"},
