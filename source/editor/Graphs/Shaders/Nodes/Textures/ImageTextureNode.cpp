...
CImageTextureNode::CImageTextureNode(int& id)
    : CShaderNode{id,
                  ...
                  {SSocketType{false, SSocketType::var_type::color, SSocketType::compiler_define(0), "color", "Colour"},
                   SSocketType{false, SSocketType::var_type::float_type, SSocketType::compiler_define(0), "alpha", "Alpha"}}}
{
