...
CHueSaturationValueNode::CHueSaturationValueNode(int& id)
    : CShaderNode{id,
                  {SSocketType{.type = SSocketType::var_type::color, .name = "colour", .uiName = "Colour"},
                   SSocketType{.type = SSocketType::var_type::float_type, .name = "mix_mode_hue", .uiName = "Hue"},
                   SSocketType{.type = SSocketType::var_type::float_type, .name = "mix_mode_saturation", .uiName = "Saturation"},
                   SSocketType{.type = SSocketType::var_type::float_type, .name = "mix_mode_value", .uiName = "Value"},
