...
std::string CBrightContrast::Evaluate(std::vector<INode*>::iterator& begin, std::set<std::string>& bindings, std::set< std::string >& includes, EAttributeType::Enum attributeType)
{
    ...
    std::string shader;
    shader = std::format( "{}*{}+{}", m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format( "vec3({},{},{})", std::to_string( m_color[0] ), std::to_string( m_color[1] ), std::to_string( m_color[2] )), m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_contrast ), m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_brightness ));
...
std::string CGamma::Evaluate(std::vector<INode*>::iterator& begin, std::set<std::string>& bindings, std::set< std::string >& includes, EAttributeType::Enum attributeType)
{
    ...
    includes.insert( "colorMath.glsl" );
    std::string shader;
    shader = std::format( "pow({},{})"
            , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format( "vec3({},{},{})", std::to_string( m_color[0] ), std::to_string( m_color[1] ), std::to_string( m_color[2] ))
            , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_gamma ));
...
std::string CHueSaturationValue::Evaluate(std::vector<INode*>::iterator& begin, std::set<std::string>& bindings, std::set< std::string >& includes, EAttributeType::Enum attributeType)
{
    ...
    includes.insert( "colorMath.glsl" );
    std::string shader;
    shader = std::format( "HueSatVal({},{},{},{})"
            , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_hue )
            , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_saturation )
            , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_value )
            , m_connected[3] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor )
            , m_connected[4] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format( "vec3({},{},{})", std::to_string( m_color[0] ), std::to_string( m_color[1] ), std::to_string( m_color[2] ))
            );
...
std::string CInvert::Evaluate(std::vector<INode*>::iterator& begin, std::set<std::string>& bindings, std::set< std::string >& includes, EAttributeType::Enum attributeType)
{
    ...
    includes.insert( "colorMath.glsl" );
    std::string shader;
    shader = std::format( "Invert({},{})"
            , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format( "vec3({},{},{})", std::to_string( m_color[0] ), std::to_string( m_color[1] ), std::to_string( m_color[2] ))
            , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
...
std::string CMix::Evaluate(std::vector<INode*>::iterator& begin, std::set<std::string>& bindings, std::set< std::string >& includes, EAttributeType::Enum attributeType)
{
    ...
    {
        case EMode::Add:
            shader = std::format( "Add({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Subtract:
            shader = std::format( "Subtract({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Multiply:
            shader = std::format( "Multiply({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Screen:
                        shader = std::format( "Screen({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Divide:
                        shader = std::format( "Divide({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Difference:
                        shader = std::format( "Difference({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Darken:
                        shader = std::format( "Darken({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Lighten:
                        shader = std::format( "Lighten({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Overlay:
                        shader = std::format( "Overlay({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::ColorDodge:
                        shader = std::format( "ColorDodge({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::ColorBurn:
                        shader = std::format( "ColorBurn({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Hue:
                        shader = std::format( "Hue({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Saturation:
                        shader = std::format( "Saturation({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::Value:
                        shader = std::format( "Value({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::ColorMix:
                        shader = std::format( "ColorMix({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::SoftLight:
                        shader = std::format( "SoftLight({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
        case EMode::LinearLight:
            shader = std::format( "LinearLight({},{},{})"
                    , m_connected[0] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color1[0] ), std::to_string( m_color1[1] ), std::to_string( m_color1[2] ))
                    , m_connected[1] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Color ) : std::format("vec3({},{},{})", std::to_string( m_color2[0] ), std::to_string( m_color2[1] ), std::to_string( m_color2[2] ))
                    , m_connected[2] ? ( *( begin++ ))->Evaluate( begin, bindings, includes, EAttributeType::Float ) : std::to_string( m_factor ));
            break;
