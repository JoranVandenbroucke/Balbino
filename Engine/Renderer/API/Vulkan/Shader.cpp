...
FawnVision::CShader::CShader( const CDevice* pDevice )
...
void FawnVision::CShader::Initialize( const void* pShaderCode, size_t shaderCodeSize, shader_stage stage )
{
    ...
    switch ( stage )
    {
        ...
        case shader_stage_closest_hit:
            stageBits = VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR;
            break;
...
void FawnVision::CFileIncluder::ReleaseInclude( shaderc_include_result* includeResult )
{
