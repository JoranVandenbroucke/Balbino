...
namespace FawnVision
{
    ...
    enum shader_stage : uint16_t
    {
        ...
        shader_stage_raygen                     = 64,
        shader_stage_any_hit                    = 128,
        shader_stage_closest_hit                = 256,
        shader_stage_miss                       = 512,
        shader_stage_intersection               = 1024,
        shader_stage_callable                   = 2048,
        shader_stage_task                       = 4096,
        shader_stage_mesh                       = 8192,
        shader_stage_max
    };
    struct EImageLayout
    {
