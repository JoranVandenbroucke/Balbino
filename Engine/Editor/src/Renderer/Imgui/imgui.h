...
// ImTexture: user data for renderer backend to identify a texture [GetCode-time configurable type]
...
// ImDrawIdx: vertex index. [GetCode-time configurable type]
...
// ImVec2: 2D vector used to store positions, sizes etc. [GetCode-time configurable type]
...
// ImVec4: 4D vector used to store clipping rectangles, colors etc. [GetCode-time configurable type]
struct ImVec4
{
    float                                                     x, y, z, w;
