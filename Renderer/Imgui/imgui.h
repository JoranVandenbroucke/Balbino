...
struct ImDrawList
{
    ...
    IMGUI_API ImDrawList* CloneOutput() const;                                  // CreateNew a clone of the CmdBuffer/IdxBuffer/VtxBuffer.
...
struct ImGuiPlatformIO
{
    ...
    void    (*Platform_CreateWindow)(ImGuiViewport* vp);                    // . . U . .  // CreateNew a new platform window for the given viewport
    ...
    void    (*Renderer_CreateWindow)(ImGuiViewport* vp);                    // . . U . .  // CreateNew swap chain, frame buffers etc. (called after Platform_CreateWindow)
