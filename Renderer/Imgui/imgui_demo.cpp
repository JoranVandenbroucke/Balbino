...
static void ShowDemoWindowWidgets()
{
    ...
    if ( ImGui::TreeNode( "Basic" ))
    {
        ...
        
        {
            ...
            IMGUI_DEMO_MARKER( "Widgets/Basic/DrawInputText" );
            ...
            HelpMarker( "USER:\n"
                        ...
                        "ESCAPE to revert.\n\n"
                        "PROGRAMMER:\n"
                        "You can use the ImGuiInputTextFlags_CallbackResize facility if you need to wire DrawInputText() "
    ...
    if ( ImGui::TreeNode( "Selectables" ))
    {
        ...
        if ( ImGui::TreeNode( "Grid" ))
        {
            ...
            const bool  winning_state = memchr( selected, 0,
                                                sizeof( selected )) == NULL; // If all cells are selected...
            if ( winning_state )
            {
    ...
    if ( ImGui::TreeNode( "Text Input" ))
    {
        ...
        if ( ImGui::TreeNode( "Resize Callback" ))
        {
            ...
            HelpMarker(
                    "Using ImGuiInputTextFlags_CallbackResize to wire your custom string type to DrawInputText().\n\n"
            ...
            struct Funcs
            {
                ...
                static bool MyInputTextMultiline( const char* label, ImVector<char>* my_str, const ImVec2& size = ImVec2(
                        0, 0 ), ImGuiInputTextFlags flags = 0 )
                {
    ...
    if ( ImGui::TreeNode( "Color/Picker Widgets" ))
    {
        ...
        ImGuiColorEditFlags misc_flags = ( hdr ? ImGuiColorEditFlags_HDR : 0 ) | ( drag_and_drop
                                                                                   ? 0
                                                                                   : ImGuiColorEditFlags_NoDragDrop ) | ( alpha_half_preview
    ...
    if ( ImGui::TreeNode( "Querying Item Status (Edited/Active/Hovered etc.)" ))
    {
        ...
        if ( item_type == 5 )
        {
            ret = ImGui::InputText( "ITEM: DrawInputText", &str[0], IM_ARRAYSIZE( str ));
        ...
        ImGui::BulletText( "Return value = %d\n"
                           ...
                           "GetItemRectSize() = (%.1f, %.1f)", ret, ImGui::IsItemFocused(), ImGui::IsItemHovered(),
    ...
    if ( ImGui::TreeNode( "Querying Window Status (Focused/Hovered etc.)" ))
    {
        ...
        ImGui::BulletText( "IsWindowHovered() = %d\n"
                           ...
                           ImGui::IsWindowHovered( ImGuiHoveredFlags_ChildWindows ), ImGui::IsWindowHovered(
...
static void ShowDemoWindowLayout()
{
    ...
    if ( ImGui::TreeNode( "Scrolling" ))
    {
        ...
        for ( int i = 0; i < 5; i++ )
        {
            ...
            bool             child_is_visible = ImGui::BeginChild( child_id, ImVec2( -100, child_height ), true,
                                                                   child_flags );
            if ( scroll_to_off )
            {
        ...
        for ( int line         = 0; line < lines; line++ )
        {
            ...
            for ( int n           = 0; n < num_buttons; n++ )
            {
                ...
                char num_buf[16];
                sprintf( num_buf, "%d", n );
                const char* label = ( !( n % 15 )) ? "FizzBuzz" : ( !( n % 3 )) ? "Fizz" : ( !( n % 5 ))
                                                                                           ? "Buzz"
                                                                                           : num_buf;
                float hue = n * 0.05f;
...
static void EditTableSizingFlags( ImGuiTableFlags* p_flags )
{
    ...
    const char* preview_text = ( idx < IM_ARRAYSIZE( policies )) ? policies[idx].Name + ( idx > 0 ? strlen(
            "ImGuiTableFlags" ) : 0 ) : "";
...
static void ShowDemoWindowTables()
{
    ...
    if ( ImGui::TreeNode( "Sizing policies" ))
    {
        ...
        ImGui::Combo( "Contents", &contents_type,
                      "Show width\0Short Text\0Long Text\0Button\0Fill Button\0DrawInputText\0" );
            ...
            for ( int row = 0; row < 6; row++ )
            {
                ...
                if ( row_bg_type != 0 )
                {
                    ImU32 row_bg_color = ImGui::GetColorU32(
                            row_bg_type == 1 ? ImVec4( 0.7f, 0.3f, 0.3f, 0.65f ) : ImVec4( 0.2f + row * 0.1f, 0.2f,
                                                                                           0.2f,
    ...
    if ( ImGui::TreeNode( "Tree view" ))
    {
        ...
        if ( ImGui::BeginTable( "3ways", 3, flags ))
        {
            ...
            static const MyTreeNode nodes[] = {{ "Root",                          "Folder",      -1,     1,  3 }, // 0
    ...
    if ( ImGui::TreeNode( "Synced instances" ))
    {
        ...
        for ( int n = 0; n < 3; n++ )
        {
            ...
            if ( open && ImGui::BeginTable( "Table", 3,
                                            ImGuiTableFlags_Resizable | ImGuiTableFlags_Reorderable | ImGuiTableFlags_Hideable | ImGuiTableFlags_Borders | ImGuiTableFlags_SizingFixedFit | ImGuiTableFlags_NoSavedSettings ))
            {
                ImGui::TableSetupColumn( "One" );
                ImGui::TableSetupColumn( "Two" );
                ImGui::TableSetupColumn( "Three" );
    ...
    if ( ImGui::TreeNode( "Advanced" ))
    {
                                ...
                                inner_width_to_use ))
        {
            ...
            const bool sorts_specs_using_quantity = ( ImGui::TableGetColumnFlags(
                    3 ) & ImGuiTableColumnFlags_IsSorted ) != 0;
...
void ShowExampleAppDocuments( bool* p_open )
{
    ...
    enum Target
    {
        Target_None, Target_Tab,                 // Create documents as local tab into a local tab bar
