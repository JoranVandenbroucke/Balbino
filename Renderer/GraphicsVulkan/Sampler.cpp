...
void BalVulkan::CSampler::Initialize( int filterMode, int mipmapMode, ESamplerAddressMode::Enum samplerAddressModeU, ESamplerAddressMode::Enum samplerAddressModeV, ESamplerAddressMode::Enum samplerAddressModeW, int anisotropy, uint32_t mipLevels )
{
    ...
    const VkSamplerCreateInfo samplerInfo{
            ...
            .flags = 0,
            .magFilter = static_cast<VkFilter>( filterMode ),
            .minFilter = static_cast<VkFilter>( mipmapMode ),
            .mipmapMode = VK_SAMPLER_MIPMAP_MODE_LINEAR,
            .addressModeU = static_cast<VkSamplerAddressMode>( samplerAddressModeU ),
            .addressModeV = static_cast<VkSamplerAddressMode>( samplerAddressModeV ),
            .addressModeW = static_cast<VkSamplerAddressMode>( samplerAddressModeW ),
            .mipLodBias = 0.0f,
            .anisotropyEnable = GetDevice()->GetPhysicalDeviceInfo()->deviceFeatures.samplerAnisotropy,
            .maxAnisotropy = float(( GetDevice()->GetPhysicalDeviceInfo()->deviceFeatures.samplerAnisotropy == VK_TRUE )
                                   ? (( anisotropy > 0 )
                                      ? anisotropy
    ...
    CheckVkResult( vkCreateSampler( GetDevice()->GetVkDevice(), &samplerInfo, nullptr, &m_sampler ),
