...
namespace BalVulkan
{
	...
	enum class EPipelineStageFlagBits
	{
	...
	EImageUsageFlagBits operator|( EImageUsageFlagBits lhs, EImageUsageFlagBits rhs );
	EMemoryPropertyFlagBits operator|( EMemoryPropertyFlagBits lhs, EMemoryPropertyFlagBits rhs );
	EBufferUsageFlagBits operator|( EBufferUsageFlagBits lhs, EBufferUsageFlagBits rhs );
}
