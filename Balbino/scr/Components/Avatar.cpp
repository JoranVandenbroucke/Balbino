...
void Balbino::Avatar::Create()
{
	...
	m_ConsoleAudio->AddSound( "SoundEffects/Fire.ogg" );
	m_ConsoleAudio->AddSound( "SoundEffects/Duck.ogg" );
	m_ConsoleAudio->AddSound( "SoundEffects/Jump.ogg" );
	m_ConsoleAudio->AddSound( "SoundEffects/Fart.ogg" );

	m_LoggedAudio = GetComponent<LoggedAudio>();
	m_LoggedAudio->AddSound( "SoundEffects/Fire.ogg" );
	m_LoggedAudio->AddSound( "SoundEffects/Duck.ogg" );
	m_LoggedAudio->AddSound( "SoundEffects/Jump.ogg" );
...
{
	std::shared_ptr<Balbino::Command> cmd = InputManager::IsPressed();
	if( cmd )
	{
		cmd->Execute( *this );
	}
