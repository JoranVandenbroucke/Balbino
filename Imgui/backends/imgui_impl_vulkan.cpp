...
//  2016-10-18: Vulkan: Add location decorators & change to use structs as in/out in glsl, update embedded spv (produced with glslangValidator -x). nullptr the released resources.
...
static vk::DeviceSize g_BufferMemoryAlignment = 256;
static vk::PipelineCreateFlags g_PipelineCreateFlags = static_cast<vk::PipelineCreateFlagBits>( 0x00 );
...
static vk::ShaderModule g_ShaderModuleVert;
static vk::ShaderModule g_ShaderModuleFrag;
...
#define IMGUI_VULKAN_FUNC_MAP(IMGUI_VULKAN_FUNC_MAP_MACRO) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::AllocateCommandBuffers) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::AllocateDescriptorSets) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::AllocateMemory) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::BindBufferMemory) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::BindImageMemory) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdBindDescriptorSets) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdBindIndexBuffer) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdBindPipeline) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdBindVertexBuffers) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdCopyBufferToImage) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdDrawIndexed) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdPipelineBarrier) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdPushConstants) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdSetScissor) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdSetViewport) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateBuffer) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateCommandPool) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateDescriptorSetLayout) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateFence) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateFramebuffer) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateGraphicsPipelines) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateImage) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateImageView) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreatePipelineLayout) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateRenderPass) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateSampler) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateSemaphore) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateShaderModule) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CreateSwapchainKHR) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyBuffer) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyCommandPool) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyDescriptorSetLayout) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyFence) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyFramebuffer) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyImage) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyImageView) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyPipeline) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyPipelineLayout) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyRenderPass) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroySampler) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroySemaphore) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroyShaderModule) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroySurfaceKHR) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DestroySwapchainKHR) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::DeviceWaitIdle) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::FlushMappedMemoryRanges) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::FreeCommandBuffers) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::FreeMemory) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::GetBufferMemoryRequirements) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::GetImageMemoryRequirements) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::GetPhysicalDeviceMemoryProperties) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::GetPhysicalDeviceSurfaceCapabilitiesKHR) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::GetPhysicalDeviceSurfaceFormatsKHR) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::GetPhysicalDeviceSurfacePresentModesKHR) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::GetSwapchainImagesKHR) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::MapMemory) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::UnmapMemory) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::UpdateDescriptorSets) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::GetPhysicalDeviceSurfaceSupportKHR) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::WaitForFences) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdBeginRenderPass) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::CmdEndRenderPass) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::QueuePresentKHR) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::BeginCommandBuffer) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::EndCommandBuffer) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::ResetFences) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::QueueSubmit) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::ResetCommandPool) \
    IMGUI_VULKAN_FUNC_MAP_MACRO(vk::AcquireNextImageKHR)
...
static uint32_t ImGui_ImplVulkan_MemoryType( vk::MemoryPropertyFlags properties, uint32_t type_bits )
{
	...
	v->PhysicalDevice.getMemoryProperties( &prop );
...
static void CreateOrResizeBuffer( vk::Buffer& buffer, vk::DeviceMemory& buffer_memory, vk::DeviceSize& p_buffer_size, size_t new_size, vk::BufferUsageFlagBits usage )
{
	...
	const vk::DeviceSize vertex_buffer_size_aligned = ( ( new_size - 1 ) / g_BufferMemoryAlignment + 1 ) * g_BufferMemoryAlignment;
...
static void ImGui_ImplVulkan_SetupRenderState( ImDrawData* draw_data, vk::Pipeline pipeline, vk::CommandBuffer command_buffer, ImGui_ImplVulkanH_FrameRenderBuffers* rb, int fb_width, int fb_height )
{
	// Bind pipeline and descriptor sets:
	{
		...
		command_buffer.bindDescriptorSets( vk::PipelineBindPoint::eGraphics, g_PipelineLayout, 0, 1, desc_set, 0, nullptr );
	}
	...
	// Our visible imgui space lies from draw_data->DisplayPps (top left) to draw_data->DisplayPos+data_data->DisplaySize (bottom right). DisplayPos is (0,0) for single viewport apps.
	{
		...
		command_buffer.pushConstants( g_PipelineLayout, vk::ShaderStageFlagBits::eVertex, sizeof( float ) * 0, sizeof( float ) * 2, scale );
		command_buffer.pushConstants( g_PipelineLayout, vk::ShaderStageFlagBits::eVertex, sizeof( float ) * 2, sizeof( float ) * 2, translate );
	}
}
...
void ImGui_ImplVulkan_RenderDrawData( ImDrawData* draw_data, vk::CommandBuffer command_buffer, vk::Pipeline pipeline )
{
	...
	auto viewport_renderer_data = static_cast<ImGuiViewportDataVulkan*>( draw_data->OwnerViewport->RendererUserData );
	...
	if ( draw_data->TotalVtxCount > 0 )
	{
		...
		vk::Result err = v->Device.mapMemory( rb->VertexBufferMemory, static_cast<vk::DeviceSize>( 0 ), rb->VertexBufferSize, vk::MemoryMapFlags( 0 ), ( void** )( &vtx_dst ) );
		check_vk_result( err );
		err = v->Device.mapMemory( rb->IndexBufferMemory, static_cast<vk::DeviceSize>( 0 ), rb->IndexBufferSize, vk::MemoryMapFlags( 0 ), ( void** )( &idx_dst ) );
		check_vk_result( err );
...
bool ImGui_ImplVulkan_CreateFontsTexture( vk::CommandBuffer command_buffer )
{
	...
	// Create the Image:
	{
		...
		err = v->Device.createImage( &info, v->Allocator, &g_FontImage );
		check_vk_result( err );
		vk::MemoryRequirements req;
		v->Device.getImageMemoryRequirements( g_FontImage, &req );
		vk::MemoryAllocateInfo alloc_info {};
		alloc_info.sType = vk::StructureType::eMemoryAllocateInfo;
		alloc_info.allocationSize = req.size;
		alloc_info.memoryTypeIndex = ImGui_ImplVulkan_MemoryType( vk::MemoryPropertyFlagBits::eDeviceLocal, req.memoryTypeBits );
		err = v->Device.allocateMemory( &alloc_info, v->Allocator, &g_FontMemory );
		check_vk_result( err );
		v->Device.bindImageMemory( g_FontImage, g_FontMemory, 0 );
	}
	...
	// Create the Image View:
	{
		...
		err = v->Device.createImageView( &info, v->Allocator, &g_FontView );
		check_vk_result( err );
	}
	...
	// Update the Descriptor Set:
	{
		...
		write_desc[0].sType = vk::StructureType::eWriteDescriptorSet;
		write_desc[0].dstSet = g_DescriptorSet;
		write_desc[0].descriptorCount = 1;
		write_desc[0].descriptorType = vk::DescriptorType::eCombinedImageSampler;
		write_desc[0].pImageInfo = desc_image;
		v->Device.updateDescriptorSets( 1, write_desc, 0, nullptr );
	}
	...
	// Create the Upload Buffer:
	{
		...
		buffer_info.sharingMode = vk::SharingMode::eExclusive;
		err = v->Device.createBuffer( &buffer_info, v->Allocator, &g_UploadBuffer );
		check_vk_result( err );
		vk::MemoryRequirements req;
		v->Device.getBufferMemoryRequirements( g_UploadBuffer, &req );
		g_BufferMemoryAlignment = ( g_BufferMemoryAlignment > req.alignment ) ? g_BufferMemoryAlignment : req.alignment;
		vk::MemoryAllocateInfo alloc_info {};
		alloc_info.sType = vk::StructureType::eMemoryAllocateInfo;
		alloc_info.allocationSize = req.size;
		alloc_info.memoryTypeIndex = ImGui_ImplVulkan_MemoryType( vk::MemoryPropertyFlagBits::eHostVisible, req.memoryTypeBits );
		err = v->Device.allocateMemory( &alloc_info, v->Allocator, &g_UploadBufferMemory );
		check_vk_result( err );
		v->Device.bindBufferMemory( g_UploadBuffer, g_UploadBufferMemory, 0 );
		check_vk_result( err );
	}
	...
	{
		char* map = nullptr;
		err = v->Device.mapMemory( g_UploadBufferMemory, static_cast<vk::DeviceSize>( 0 ), upload_size, vk::MemoryMapFlags( 0 ), ( void** )( &map ) );
		check_vk_result( err );
		...
		check_vk_result( err );
		v->Device.unmapMemory( g_UploadBufferMemory );
	}
	...
	// Copy to Image:
	{
		...
		//copy_barrier[0].dstAccessMask = vk::AccessFlagBits::eHostWrite;
		...
		command_buffer.pipelineBarrier( vk::PipelineStageFlagBits::eHost, vk::PipelineStageFlagBits::eTransfer, vk::DependencyFlagBits( 0 ), 0, nullptr, 0, nullptr, 1, copy_barrier );
		...
		command_buffer.pipelineBarrier( vk::PipelineStageFlagBits::eTransfer, vk::PipelineStageFlagBits::eFragmentShader, vk::DependencyFlagBits( 0 ), 0, nullptr, 0, nullptr, 1, use_barrier );
	}

	// Store our identifier
	io.Fonts->SetTexID( g_FontImage );
...
static void ImGui_ImplVulkan_CreateShaderModules( vk::Device device, const vk::AllocationCallbacks* allocator )
{
	...
	if ( g_ShaderModuleVert == 0 )
	{
		vk::ShaderModuleCreateInfo vert_info {};
		vert_info.sType = vk::StructureType::eShaderModuleCreateInfo;
		vert_info.codeSize = sizeof( glsl_shader_vert_spv );
		vert_info.pCode = static_cast<uint32_t*>( glsl_shader_vert_spv );
		const vk::Result err = device.createShaderModule( &vert_info, allocator, &g_ShaderModuleVert );
		check_vk_result( err );
	}
	if ( g_ShaderModuleFrag == 0 )
	{
		vk::ShaderModuleCreateInfo frag_info {};
		frag_info.sType = vk::StructureType::eShaderModuleCreateInfo;
		frag_info.codeSize = sizeof( glsl_shader_frag_spv );
		frag_info.pCode = static_cast<uint32_t*>( glsl_shader_frag_spv );
		const vk::Result err = device.createShaderModule( &frag_info, allocator, &g_ShaderModuleFrag );
		check_vk_result( err );
	}
}
...
static void ImGui_ImplVulkan_CreateFontSampler( vk::Device device, const vk::AllocationCallbacks* allocator )
{
	...
	const vk::Result err = device.createSampler( &info, allocator, &g_FontSampler );
	check_vk_result( err );
}
...
static void ImGui_ImplVulkan_CreateDescriptorSetLayout( vk::Device device, const vk::AllocationCallbacks* allocator )
{
	...
	const vk::Result err = device.createDescriptorSetLayout( &info, allocator, &g_DescriptorSetLayout );
	check_vk_result( err );
}
...
static void ImGui_ImplVulkan_CreatePipelineLayout( vk::Device device, const vk::AllocationCallbacks* allocator )
{
	...
	const vk::Result err = device.createPipelineLayout( &layout_info, allocator, &g_PipelineLayout );
	check_vk_result( err );
}
...
static void ImGui_ImplVulkan_CreatePipeline( vk::Device device, const vk::AllocationCallbacks* allocator, vk::PipelineCache pipelineCache, vk::RenderPass renderPass, vk::SampleCountFlagBits MSAASamples, vk::Pipeline* pipeline, uint32_t subpass )
{
	...
	stage[0].sType = vk::StructureType::ePipelineShaderStageCreateInfo;
	stage[0].stage = vk::ShaderStageFlagBits::eVertex;
	stage[0].module = g_ShaderModuleVert;
	stage[0].pName = "main";
	stage[1].sType = vk::StructureType::ePipelineShaderStageCreateInfo;
	...
	vertex_info.sType = vk::StructureType::ePipelineVertexInputStateCreateInfo;
	...
	ia_info.sType = vk::StructureType::ePipelineInputAssemblyStateCreateInfo;
	...
	raster_info.sType = vk::StructureType::ePipelineRasterizationStateCreateInfo;
	...
	ms_info.sType = vk::StructureType::ePipelineMultisampleStateCreateInfo;
	ms_info.rasterizationSamples = ( MSAASamples != static_cast<vk::SampleCountFlagBits>( 0 ) ) ? MSAASamples : vk::SampleCountFlagBits::e1;
	...
	depth_info.sType = vk::StructureType::ePipelineDepthStencilStateCreateInfo;

	vk::PipelineColorBlendStateCreateInfo blend_info {};
	blend_info.sType = vk::StructureType::ePipelineColorBlendStateCreateInfo;
...
bool ImGui_ImplVulkan_CreateDeviceObjects()
{
	...
	if ( !g_FontSampler )
	{
		...
		info.maxLod = 1000;
		info.maxAnisotropy = 1.0f;
		err = v->Device.createSampler( &info, v->Allocator, &g_FontSampler );
		check_vk_result( err );
	}
	...
	if ( !g_DescriptorSetLayout )
	{
		...
		info.bindingCount = 1;
		info.pBindings = binding;
		err = v->Device.createDescriptorSetLayout( &info, v->Allocator, &g_DescriptorSetLayout );
		check_vk_result( err );
	}
	...
	// Create Descriptor Set:
	{
		...
		err = v->Device.allocateDescriptorSets( &alloc_info, &g_DescriptorSet );
		check_vk_result( err );
	}
	...
	if ( !g_PipelineLayout )
	{
		...
		layout_info.pushConstantRangeCount = 1;
		layout_info.pPushConstantRanges = push_constants;
		err = v->Device.createPipelineLayout( &layout_info, v->Allocator, &g_PipelineLayout );
		check_vk_result( err );
	}
...
void ImGui_ImplVulkan_DestroyFontUploadObjects()
{
	...
	if ( g_UploadBuffer )
	{
		v->Device.destroy( g_UploadBuffer, v->Allocator );
		g_UploadBuffer = VK_NULL_HANDLE;
	}
	if ( g_UploadBufferMemory )
	{
		v->Device.freeMemory( g_UploadBufferMemory, v->Allocator );
...
void ImGui_ImplVulkan_DestroyDeviceObjects()
{
	...
	{
		v->Device.destroyShaderModule( g_ShaderModuleVert, v->Allocator );
		g_ShaderModuleVert = VK_NULL_HANDLE;
	}
	if ( g_ShaderModuleFrag )
	{
		v->Device.destroyShaderModule( g_ShaderModuleFrag, v->Allocator );
		g_ShaderModuleFrag = VK_NULL_HANDLE;
	}
	if ( g_FontView )
	{
		v->Device.destroyImageView( g_FontView, v->Allocator );
		g_FontView = VK_NULL_HANDLE;
	}
	if ( g_FontImage )
	{
		v->Device.destroyImage( g_FontImage, v->Allocator );
		g_FontImage = VK_NULL_HANDLE;
	}
	if ( g_FontMemory )
	{
		v->Device.freeMemory( g_FontMemory, v->Allocator );
		g_FontMemory = VK_NULL_HANDLE;
	}
	if ( g_FontSampler )
	{
		v->Device.destroySampler( g_FontSampler, v->Allocator );
		g_FontSampler = VK_NULL_HANDLE;
	}
	if ( g_DescriptorSetLayout )
	{
		v->Device.destroyDescriptorSetLayout( g_DescriptorSetLayout, v->Allocator );
		g_DescriptorSetLayout = VK_NULL_HANDLE;
	}
	if ( g_PipelineLayout )
	{
		v->Device.destroyPipelineLayout( g_PipelineLayout, v->Allocator );
		g_PipelineLayout = VK_NULL_HANDLE;
	}
	if ( g_Pipeline )
	{
		v->Device.destroyPipeline( g_Pipeline, v->Allocator );
...
bool ImGui_ImplVulkan_Init( ImGui_ImplVulkan_InitInfo* info, vk::RenderPass render_pass )
{
	...
	IM_ASSERT( info->Instance != 0 );
	IM_ASSERT( info->PhysicalDevice != 0 );
	IM_ASSERT( info->Device != 0 );
	IM_ASSERT( info->Queue != 0 );
	IM_ASSERT( info->DescriptorPool != 0 );
	IM_ASSERT( info->MinImageCount >= 2 );
	IM_ASSERT( info->ImageCount >= info->MinImageCount );
	IM_ASSERT( render_pass != 0 );
...
void ImGui_ImplVulkan_Shutdown()
{
	...
	ImGuiViewport* main_viewport = ImGui::GetMainViewport();
	if ( auto data = static_cast<ImGuiViewportDataVulkan*>( main_viewport->RendererUserData ) )
		IM_DELETE( data );
...
vk::SurfaceFormatKHR ImGui_ImplVulkanH_SelectSurfaceFormat( vk::PhysicalDevice physical_device, vk::SurfaceKHR surface, const vk::Format* request_formats, int request_formats_count, vk::ColorSpaceKHR request_color_space )
{
	...
	physical_device.getSurfaceFormatsKHR( surface, &avail_count, nullptr );
	ImVector<vk::SurfaceFormatKHR> avail_format;
	avail_format.resize( static_cast<int>( avail_count ) );
	physical_device.getSurfaceFormatsKHR( surface, &avail_count, avail_format.Data );
...
vk::PresentModeKHR ImGui_ImplVulkanH_SelectPresentMode( vk::PhysicalDevice physical_device, vk::SurfaceKHR surface, const vk::PresentModeKHR* request_modes, int request_modes_count )
{
	...
	physical_device.getSurfacePresentModesKHR( surface, &avail_count, nullptr );
	ImVector<vk::PresentModeKHR> avail_modes;
	avail_modes.resize( static_cast<int>( avail_count ) );
	physical_device.getSurfacePresentModesKHR( surface, &avail_count, avail_modes.Data );
	//for (uint32_t avail_i = 0; avail_i < avail_count; avail_i++)
...
void ImGui_ImplVulkanH_CreateWindowCommandBuffers( vk::PhysicalDevice physical_device, vk::Device device, ImGui_ImplVulkanH_Window* wd, uint32_t queue_family, const vk::AllocationCallbacks* allocator )
{
	IM_ASSERT( physical_device != 0 && device != 0 );
...
void ImGui_ImplVulkanH_CreateWindowSwapChain( vk::PhysicalDevice physical_device, vk::Device device, ImGui_ImplVulkanH_Window* wd, const vk::AllocationCallbacks* allocator, int w, int h, uint32_t min_image_count )
{
	...
	// Create Swapchain
	{
		...
		err = physical_device.getSurfaceCapabilitiesKHR( wd->Surface, &cap );
		check_vk_result( err );
		...
		check_vk_result( err );
		err = device.getSwapchainImagesKHR( wd->Swapchain, &wd->ImageCount, nullptr );
		check_vk_result( err );
		vk::Image backbuffers[16] {};
		IM_ASSERT( wd->ImageCount >= min_image_count );
		IM_ASSERT( wd->ImageCount < IM_ARRAYSIZE( backbuffers ) );
		err = device.getSwapchainImagesKHR( wd->Swapchain, &wd->ImageCount, backbuffers );
		check_vk_result( err );
...
void ImGui_ImplVulkanH_DestroyFrameRenderBuffers( vk::Device device, ImGui_ImplVulkanH_FrameRenderBuffers* buffers, const vk::AllocationCallbacks* allocator )
{
	...
	{
		device.destroyBuffer( buffers->VertexBuffer, allocator );
		buffers->VertexBuffer = VK_NULL_HANDLE;
	}
	if ( buffers->VertexBufferMemory )
	{
		device.freeMemory( buffers->VertexBufferMemory, allocator );
		buffers->VertexBufferMemory = VK_NULL_HANDLE;
	}
	if ( buffers->IndexBuffer )
	{
		device.destroyBuffer( buffers->IndexBuffer, allocator );
		buffers->IndexBuffer = VK_NULL_HANDLE;
	}
	if ( buffers->IndexBufferMemory )
	{
		device.freeMemory( buffers->IndexBufferMemory, allocator );
...
void ImGui_ImplVulkanH_DestroyAllViewportsRenderBuffers( vk::Device device, const vk::AllocationCallbacks* allocator )
{
	...
	for ( int n = 0; n < platform_io.Viewports.Size; n++ )
		if ( auto data = static_cast<ImGuiViewportDataVulkan*>( platform_io.Viewports[n]->RendererUserData ) )
...
{
	auto data = IM_NEW( ImGuiViewportDataVulkan )();
	...
	// Create surface
	ImGuiPlatformIO& platform_io = ImGui::GetPlatformIO();
	VkInstance inst = v->Instance;
	const auto err = static_cast<vk::Result>( platform_io.Platform_CreateVkSurface( viewport, ( ImU64 )inst, static_cast<const void*>( v->Allocator ), ( ImU64* )&wd->Surface ) );
	check_vk_result( err );
	...
	const vk::Format requestSurfaceImageFormat[] { vk::Format::eB8G8R8A8Unorm, vk::Format::eR8G8B8A8Unorm, vk::Format::eB8G8R8Unorm, vk::Format::eR8G8B8A8Unorm };
	const auto requestSurfaceColorSpace = vk::ColorSpaceKHR::eSrgbNonlinear;
	wd->SurfaceFormat = ImGui_ImplVulkanH_SelectSurfaceFormat( v->PhysicalDevice, wd->Surface, requestSurfaceImageFormat, static_cast<size_t>( IM_ARRAYSIZE( requestSurfaceImageFormat ) ), requestSurfaceColorSpace );
...
static void ImGui_ImplVulkan_DestroyWindow( ImGuiViewport* viewport )
{
	...
	if ( auto data = static_cast<ImGuiViewportDataVulkan*>( viewport->RendererUserData ) )
	{
		ImGui_ImplVulkan_InitInfo* v = &g_VulkanInitInfo;
		if ( data->WindowOwned )
...
{
	auto data = static_cast<ImGuiViewportDataVulkan*>( viewport->RendererUserData );
	if ( data == nullptr ) // This is nullptr for the main viewport (which is left to the user/app to handle)
		return;
	ImGui_ImplVulkan_InitInfo* v = &g_VulkanInitInfo;
	data->Window.ClearEnable = ( viewport->Flags & ImGuiViewportFlags_NoRendererClear ) ? false : true;
	ImGui_ImplVulkanH_CreateOrResizeWindow( v->Instance, v->PhysicalDevice, v->Device, &data->Window, v->QueueFamily, v->Allocator, static_cast<int>( size.x ), static_cast<int>( size.y ), v->MinImageCount );
}
...
static void ImGui_ImplVulkan_RenderWindow( ImGuiViewport* viewport, void* )
{
	...
	ImGui_ImplVulkanH_FrameSemaphores* fsd = &wd->FrameSemaphores[wd->SemaphoreIndex];
	{
		...
		{
			v->Device.resetCommandPool( fd->CommandPool, static_cast<vk::CommandPoolResetFlagBits>( 0 ) );
			check_vk_result( err );
...
static void ImGui_ImplVulkan_SwapBuffers( ImGuiViewport* viewport, void* )
{
	...
	if ( err == vk::Result::eErrorOutOfDateKHR || err == vk::Result::eSuboptimalKHR )
		ImGui_ImplVulkanH_CreateOrResizeWindow( v->Instance, v->PhysicalDevice, v->Device, &data->Window, v->QueueFamily, v->Allocator, static_cast<int>( viewport->Size.x ), static_cast<int>( viewport->Size.y ), v->MinImageCount );
	else
		check_vk_result( err );
...
void ImGui_ImplVulkan_InitPlatformInterface()
{
	...
	if ( ImGui::GetIO().ConfigFlags & ImGuiConfigFlags_ViewportsEnable )
		IM_ASSERT( platform_io.Platform_CreateVkSurface != nullptr && "Platform needs to setup the Createvk::Surface handler." );
