...
IMGUI_IMPL_API void    ImGui_ImplVulkan_DestroyTexture( VkDescriptorSet texture );
...
IMGUI_IMPL_API void                 ImGui_ImplVulkanH_RecreateWindow( VkCommandPool instance, VkQueue vkQueue, ImGui_ImplVulkanH_Window* wnd );
