...
static void WorkOnRgbe( RGBE* scan, int len, float* cols ) noexcept;
static bool Decrunch( RGBE* scanline, int len, FILE* file ) noexcept;
static bool OldDecrunch( RGBE* scanline, int len, FILE* file ) noexcept;
...
void WorkOnRgbe( RGBE* scan, int len, float* cols ) noexcept
{
    while ( len-- > 0 )
    {
...
bool Decrunch( RGBE* scanline, int len, FILE* file ) noexcept
{
    int i, j;
...
bool OldDecrunch( RGBE* scanline, int len, FILE* file ) noexcept
{
    int i;
    int rshift = 0;
